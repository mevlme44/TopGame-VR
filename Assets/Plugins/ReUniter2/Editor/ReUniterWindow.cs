...
namespace Reuniter
{
    ...
    public class ReUniterWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/ReUniter/Go To Script %,")]
        [SuppressMessage("ReSharper", "UnusedMember.Local")]
        ...
        static Texture2D FindEditorIcon(string path) {
        ...
        public static Texture2D GetIconForFile(string fileName)
        {
            ...
            {
                case "boo":
                    return FindEditorIcon("boo Script Icon");
                case "cginc":
                    return FindEditorIcon("CGProgram Icon");
                case "cs":
                    return FindEditorIcon("cs Script Icon");
                case "guiskin":
                    return FindEditorIcon("UnityEngine/GUISkin Icon");
                case "js":
                    return FindEditorIcon("Js Script Icon");
                case "mat":
                    return FindEditorIcon("UnityEngine/Material Icon");
                case "prefab":
                    return FindEditorIcon("PrefabNormal Icon");
                case "shader":
                    return FindEditorIcon("UnityEngine/Shader Icon");
                case "txt":
                    return FindEditorIcon("UnityEngine/TextAsset Icon");
                case "unity":
                    return FindEditorIcon("UnityEditor/SceneAsset Icon");
                case "asset":
                case "prefs":
                    return FindEditorIcon("GameManager Icon");
                case "anim":
                    return FindEditorIcon("UnityEngine/Animation Icon");
                case "meta":
                    return FindEditorIcon("MetaFile Icon");
                case "ttf":
                case "otf":
                case "fon":
                case "fnt":
                    return FindEditorIcon("UnityEngine/Font Icon");
                case "aac":
                case "aif":
                case "aiff":
                case "au":
                ...
                case "wave":
                case "ogg":
                    return FindEditorIcon("UnityEngine/AudioClip Icon");
                case "ai":
                case "apng":
                case "png":
                case "bmp":
                ...
                case "psd":
                case "exr":
                    return FindEditorIcon("UnityEngine/Texture Icon");
                case "3df":
                case "3dm":
                case "3dmf":
                case "3ds":
                ...
                case "wrz":
                case "fbx":
                    return FindEditorIcon("UnityEngine/Mesh Icon");
                case "asf":
                case "asx":
                case "avi":
                case "dat":
                ...
                case "wmw":
                case "xvid":
                    return FindEditorIcon("UnityEngine/MovieTexture Icon");
                case "colors":
                case "gradients":
                case "curves":
                ...
                case "particledoublecurvessigned":
                    return FindEditorIcon("UnityEngine/ScriptableObject Icon");
                case "":
                    return FindEditorIcon("Folder Icon");
            }
            return FindEditorIcon("UnityEditor/DefaultAsset Icon");
        }
            ...
            itemInfos._Each((x, index) =>
                {
                    ...
                    var icon = GetIconForFile(x.Name);
                    if (!icon) icon = Texture2D.whiteTexture;
        ...
        private void SelectItems(IEnumerable<ReUniterItemInfo> items, bool appendToSelection, bool openAssets, bool onlyPing)
        {
            ...
            if (!openAssets)
            {
                ...
                if (noneGameObject)
                {
                    ...
                    var last = projectBrowser.GetField("s_LastInteractedProjectBrowser").GetValue(null);
                    if (last == null)
